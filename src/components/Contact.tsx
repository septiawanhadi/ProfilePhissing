      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 border border-[var(--color-fg)] p-6 bg-[var(--color-bg-card)]">
          ...
          <div className="border-t border-dashed border-[var(--color-fg)] pt-4 space-y-3">
            <a href="mailto:contact@gemilang.dev" className="flex items-center gap-2 font-mono text-xs uppercase tracking-widest text-neutral-700 hover:text-[var(--color-accent)] transition-colors">
